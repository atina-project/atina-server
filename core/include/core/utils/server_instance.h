...
namespace atina::server::core::utils {
    ...
    class server_instance {
        ...
        public:
            ...
            static void exit();
            static void register_atexit(const std::function<void()>& __func, bool __b_atfatal = true);
        ...
        private:
            ...
            static std::vector<std::function<void()>> __atexit_funcs;
            static std::vector<std::function<void()>> __atfatal_funcs;
